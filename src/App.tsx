...
import { Auth } from './components/Auth'; // Auth eklendi
...
function App() {
  ...
  // Eğer oturum yoksa GİRİŞ EKRANI göster
  if (!session) {
    return <Auth />;
  }

  // Oturum varsa UYGULAMAYI göster
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden">
      ...
      <main className="flex-1 h-full w-full relative">
        {/* ChatContainer'a kullanıcının ID'sini gönderiyoruz */}
